...
function [g_ineq, h_eq]= moo_const (x)
    ...
    [d2e]=Eje_secundario(U1, Fr1, Fa1, z12, U2, Fr2, Fa2, z22, U_d, Fr_d, Fa_d, z1d, m_d, m, S_ut);
...
function [z11, z12, z21, z22, m, U1, Fr1, Fa1, U2, Fr2, Fa2]=Calculo_engranajes( ...
...
% Las relaciones se ingresan en valores >1 
    ...
    Fr1=U1*tand(alpha);           %Fuerza radial
    Fa1=U1*tand(beta);            %Fuerza axial
...
function [d1e]=Eje_principal(U1, Fr1, Fa1, z11, U2, Fr2, Fa2, z21, m, S_ut)
    ...
    M1=sqrt(M11_z^2 + M11_y^2); %Momento en el punto maximo
    ...
    M2=sqrt(M21_z^2 + M21_y^2); %Momento en el punto maximo
...
function [d2e]=Eje_secundario(U1, Fr1, Fa1, z12, U2, Fr2, Fa2, z22, U_d, Fr_d, Fa_d, z1d, m_d, m, S_ut)
    ...
    %Torque y momentos en el punto máximo
    M1=sqrt(M11_z^2 + M11_y^2); %Momento en el punto máximo
